...
{
    public abstract class MRPanelWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MRPanelWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MRPanelWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MRPanelDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MRPanelDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MRPanelDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MRPanelDbContext, Task<T>> func)
        {
            T result;
