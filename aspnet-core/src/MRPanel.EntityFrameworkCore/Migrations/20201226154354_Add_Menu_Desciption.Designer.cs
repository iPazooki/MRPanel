...
namespace MRPanel.Migrations
{
    ...
    [Migration("20201226154354_Add_Menu_Desciption")]
    partial class Add_Menu_Desciption
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MRPanel.Domain.SiteSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MRPanel.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MRPanel.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MRPanel.Domain.Widget", b =>
                {
                    ...
                    b.HasOne("MRPanel.Domain.Widget", "Parent")
                        .WithMany("Widgets")
                        .HasForeignKey("ParentId");
